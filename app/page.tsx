...
import { GraduationCap, Users, BookOpen, Award, CheckCircle2, ArrowRight, Star, ShieldCheck, Sparkles, ShoppingBag } from 'lucide-react';
    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Tailored Portals for Every Role</h2>
          <p className="text-sm text-slate-500">Choose your pathway and unlock specialized tools designed for your goals.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="hover:border-brand-500 hover:shadow-md transition-all group">
            <CardContent className="p-6 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-brand-50 text-brand-600 flex items-center justify-center font-bold group-hover:scale-110 transition-transform">
                <GraduationCap className="w-6 h-6" />
              </div>
              <div>
                <h3 className="font-bold text-slate-900 text-base">Students</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Track course progress, take interactive quizzes, earn certificates, and book mentor sessions.
                </p>
              </div>
              <Link href="/login" className="block text-xs font-bold text-brand-600 group-hover:translate-x-1 transition-transform">
          ...
          <Card className="hover:border-purple-500 hover:shadow-md transition-all group">
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-base">Instructors</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Author rich multi-module courses, create assessments, and monitor student analytics.
                </p>
              </div>
              <Link href="/login" className="block text-xs font-bold text-purple-600 group-hover:translate-x-1 transition-transform">
          ...
          <Card className="hover:border-amber-500 hover:shadow-md transition-all group">
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-base">Mentors</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Configure recurring availability, set session fees, and accept 1-on-1 consultations.
                </p>
              </div>
              <Link href="/login" className="block text-xs font-bold text-amber-600 group-hover:translate-x-1 transition-transform">
                Mentor Suite &rarr;
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:border-emerald-500 hover:shadow-md transition-all group">
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-base">Super Admins</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Govern platform operations, verify KYC submissions, approve courses, and track revenue.
                </p>
              </div>
              <Link href="/login" className="block text-xs font-bold text-emerald-600 group-hover:translate-x-1 transition-transform">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Top-rated learning experiences curated by industry professionals.</p>
          </div>
          <Link href="/courses">
                ...
                <div>
                  <div className="h-44 w-full bg-slate-200 relative overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                      ...
                      <Badge variant="outline" className="bg-white/90">{course.level}</Badge>
                    </div>
                  </div>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Book 1-on-1 sessions for career guidance, resume reviews, and code pairings.</p>
          </div>
          <Link href="/mentors">
            <Button variant="ghost" size="sm">
          ...
          {mentors.map((mentor) => (
            <Card key={mentor.id} className="p-6 space-y-4 hover:shadow-md transition-all">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-slate-200 overflow-hidden shrink-0 border-2 border-brand-500">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-sm">{mentor.user.name}</h3>
              ...
              <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">{mentor.bio}</p>
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                <span className="text-sm font-bold text-slate-900">${mentor.hourlyRate}/hr</span>
