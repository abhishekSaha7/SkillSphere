      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Schedule 1-on-1 Mentorship Session">
        <form onSubmit={handleBookSession} className="space-y-4">
          ...
          <div>
            ...
            >
              <option value="System Design Mock Interview" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">System Design Mock Interview</option>
              <option value="Resume Review & Career Roadmap" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Resume Review & Career Roadmap</option>
              <option value="1-on-1 Code Pairing" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">1-on-1 Code Pairing</option>
            </select>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-xs bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500"
            />
          </div>
