    ...
    <div className="space-y-8">
      ...
      {courses.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-2xl border border-slate-200">
          ...
          <h3 className="text-base font-semibold text-slate-700">No courses match your filter criteria</h3>
          <p className="text-xs text-slate-500 mt-1">Try resetting your search query or selecting a different category.</p>
        </div>
      ) : (
                ...
                <div>
                  ...
                  <CardContent className="p-5 space-y-3">
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 pt-3 border-t border-slate-100">
                      <span>By <strong className="text-slate-700">{course.instructor.name}</strong></span>
